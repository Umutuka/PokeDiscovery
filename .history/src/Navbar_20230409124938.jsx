...
<div className="border-b-3 mx-auto flex h-16 items-center justify-between main-menu shadow-2xl">
  <div className="w-1/4 lg:w-auto">
    <h1 className="flex cursor-pointer mr-5 items-center pb-1 font-mono text-3xl font-bold text-[#000300]">
      <img src="\Pictures\pokemon-icon.png" className="w-12 h-12 p-1"></img>PokeDiscovery
    </h1>
  </div>
  ...
  <div onClick={handleNav} className="block ml-20 m-5 lg:hidden bg-white">
...
<div
  className={
    !nav
      ? "fixed left-0 top-0 w-70% md:w-1/3 border-r border-r-gray-900 bg-[#000000] duration-500 ease-in-out"
      : "fixed left-[-100%]"
  }
>
