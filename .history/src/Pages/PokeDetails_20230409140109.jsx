...
import pokemonTypes from '../DetailCells/TypeColour.json'
  ...
  return (
    <div className="details bg-slate-200">
      ...
      <nav className="p-5">
        <div>
          {pokemon.id - 1 > 0 ? (
            <div className="relative">
              ...
              >
                <p>
                  {" "}
                  {"<=" +
                    previousPokemon.name.charAt(0).toUpperCase() +
            ...
            <Link
              to={`/${pokemon.id + 1}`}
              className="before-dex hover:bg-slate-500 p-2 rounded-lg float-right"
            >
              <p>
                {" "}
                {nextPokemon.name.charAt(0).toUpperCase() +
      ...
      <div className="flex m-5 font-bold text-lg">
        ...
        <p>
          type Pokemon introduced in Generation {generation}. It is known as the
          '{description.genera[7].genus}'{" "}
        </p>
      </div>
      ...
      <section className="pokemon-card grid grid-cols-2  border mt-10 m-2 p-5 rounded-lg bg-slate-100">
        ...
        <div className="Info border-l-4 border-l-red-500 space-y-3">
          ...
          <ul className="text-3xl flex space-x-1  font-sans">
            ...
            {pokemon.types.map((type, index) => {
              return (
                <li style={{color: pokemonTypes[0].fire}} className="pl-1" key={index}>
