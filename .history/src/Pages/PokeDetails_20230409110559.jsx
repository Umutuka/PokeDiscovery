        ...
        <div>
          ...
          {pokemon.id - 1 > 0 ? (
            <div className="relative">
              <Link to={`/${pokemon.id - 1}`} className="before-dex font-bold hover:bg-slate-500 p-2 rounded-lg float-left">
                <p> {'<=' + previousPokemon.name.charAt(0).toUpperCase() + previousPokemon.name.slice(1)}</p>
              </Link>

              <Link
                to={`/${pokemon.id + 1}`}
                className="before-dex before-dex font-bold hover:bg-slate-500 p-2 rounded-lg float-right"
              >
                <p>{nextPokemon.name.charAt(0).toUpperCase() + nextPokemon.name.slice(1) + '=>'}</p>
              </Link>
            </div>
          ) : (
            <Link to={`/${pokemon.id + 1}`} className="before-dex hover:bg-slate-500 p-2 rounded-lg float-right">
              <p> Yo</p>
            </Link>
          )}
        </div>
