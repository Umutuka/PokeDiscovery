  ...
  return (
    <div className="app-contaner">
      ...
      <div class="flex p-5 justify-center">
        <button class="bg-gray-500 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded">
          Load More
        </button>

        <button class="bg-gray-500 pl-1 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded">
          Load More
        </button>
      </div>{" "}
    </div>
