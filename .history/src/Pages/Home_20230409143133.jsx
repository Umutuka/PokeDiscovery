       ...
       <div className="all-container p-5 grid grid-cols-5 gap-4">
         {allPokemons.map( (pokemonStats, index) => 
           ...
           />)}
              ...
              <div className="flex border rounded-lg m-5 p-5 mb-10 text-2xl hover:bg-slate-200 bg-slate-600 justify-center">

           <button className="load-more justify-center" onClick={() => getAllPokemons()}>Load more</button>
