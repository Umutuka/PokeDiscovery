...
if (id - 1 > 0){
  ...
  const api3Data = api3Response ? await api3Response.json() : null;
  const api4Data = await api4Response.json();


  return {
    pokemon: api1Data,
    previousPokemon: api3Data,
    nextPokemon: api4Data,
  ...
  const [api1Response, api2Response, api4Response] = await Promise.all([
    fetch(`https://pokeapi.co/api/v2/pokemon/${id}`),
    fetch(`https://pokeapi.co/api/v2/pokemon-species/${id}/`),
    fetch(`https://pokeapi.co/api/v2/pokemon/${id + 1}/`),
  ]);
