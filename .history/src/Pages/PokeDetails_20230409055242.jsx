...
const Details = () => {
  ...
  return (
    <div className="details bg-slate-200">
      ...
      <div className=" bg-blue-200 rounded-lg m-5">
        <ul className="flex flex-wrap text-center justify-center">
          <li className="p-4 font-bold m-4 border-r-4 text-3xl w-full sm:w-auto">Contents</li>
          <li className="p-4 m-4 border-r-4 text-3xl">
            <a href="#Information">Info</a>
          </li>
          <li className="p-4 m-4 border-r-4 text-2xl">
