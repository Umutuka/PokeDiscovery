...
const fetchPokemon = async (id) => {
  ...
  const nextPokemonResponse = await fetch(`https://pokeapi.co/api/v2/pokemon/${id + 1}/`).then(res => res.json());
  ...
  const data = {
    pokemon: { ...pokemonResponse, name: name.charAt(0).toUpperCase() + name.slice(1) },
