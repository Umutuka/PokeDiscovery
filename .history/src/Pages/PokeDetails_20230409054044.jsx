    ...
    <div className="details bg-slate-200">
      ...
      <div className="border bg-slate-50 m-5">
          ...
          <li className="pr-20 border- text-3xl">Contents</li>
            <li className="pr-1 text-3xl"> <a href="#Information">Info</a></li>
            <li className="pr-1 text-3xl"><a href="#Training">Training |</a></li>
            <li className="pr-1 text-3xl"><a href="#Breeding">Breeding | </a></li>
            <li className="pr-1 text-3xl"><a href="#BaseStats">Base Stats |</a></li>
            <li className="pr-1 text-3xl"><a href="#Generation">Generation |</a></li>
            <li className="pr-1 text-3xl"><a href="#Evolution-Chain">Evolution Chain |</a></li>
