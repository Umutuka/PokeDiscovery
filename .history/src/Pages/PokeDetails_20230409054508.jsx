...
const Details = () => {
  ...
  return (
    <div className="details bg-slate-200">
      ...
      <div className="border bg-slate-50 m-5">
  <ul className="flex text-center sm:block">
    <li className="pr-20 border text-3xl">Contents</li>
    <li className="p-4 border text-3xl"><a href="#Information">Info</a></li>
    <li className="p-4 border text-3xl"><a href="#Training">Training</a></li>
    <li className="p-4 border text-3xl"><a href="#Breeding">Breeding </a></li>
    <li className="p-4 border text-3xl"><a href="#BaseStats">Base Stats</a></li>
    <li className="p-4 border text-3xl"><a href="#Generation">Generation</a></li>
    <li className="p-4 border text-3xl"><a href="#Evolution-Chain">Evolution Chain</a></li>
  </ul>
</div>
