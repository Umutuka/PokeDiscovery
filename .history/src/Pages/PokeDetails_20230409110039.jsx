          ...
          {pokemon.id - 1 > 0 ? (
            <div>
              <Link to={`/${pokemon.id - 1}`} className="before-dex float-left">
                <p>  <span class="before:absolute before:inset-y-0 before:left-0 before:content-['<=']"> </span>
{previousPokemon.name.charAt(0).toUpperCase() + previousPokemon.name.slice(1)}</p>
              </Link>
