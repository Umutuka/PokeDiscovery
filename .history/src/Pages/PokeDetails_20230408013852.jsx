        ...
        <div className="details">
            <section className="pokemon-card flex border mt-20 m-2 p-5 rounded-lg bg-slate-100">
                <div className="mr-10">
                    ...
                    <img className="m mx-auto w-52" src={pokemon.sprites.other.home.front_default}></img>
                </div>
                
            <div className="Info space-y-3">
                <p className="text-3xl font-serif">National No: {pokemon.id} </p>
                <p className="text-3xl">Type : {pokemon.types[0].type.name}</p>
                <p className="text-3xl">Height : {pokemon.height / 10} m ({Math.round(pokemon.height / 10 * 3.281)} ft)</p>
                <p className="text-3xl">Weight: {pokemon.weight / 10} kg</p>
