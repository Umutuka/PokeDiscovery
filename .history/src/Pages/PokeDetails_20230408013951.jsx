...
const Details = () => {  
    ...
    return (
        <div className="details">
            <section className="pokemon-card flex border m-2 p-5 rounded-lg bg-slate-100">
                <div className="mr-10">
                    <h1 className="name p-5 font-bold">{pokemon.name.charAt(0).toUpperCase() + pokemon.name.slice(1)}</h1>
            ...
            <div className="Info space-y-3">
                ...
                <p className="text-3xl font-sans">Type : {pokemon.types[0].type.name}</p>
