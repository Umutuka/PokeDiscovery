    ...
    <div className="details bg-slate-200">
      ...
      <div className="border bg-slate-50 m-5">
          ...
          <li className="pr-20 text-3xl">Contents</li>
            ...
            <li className="pr-1"><a href="#Training">Training |</a></li>
            <li className="pr-1"><a href="#Breeding">Breeding | </a></li>
            <li className="pr-1"><a href="#BaseStats">Base Stats |</a></li>
            <li className="pr-1"><a href="#Generation">Generation |</a></li>
            <li className="pr-1"><a href="#Evolution-Chain">Evolution Chain |</a></li>
