...
const Breeding = ({ eggGroups, gender, eggCycles }) => {
  return (
    <div className="p-11 text-base font-semibold border rounded-lg bg-slate-300 justify-center items-center text-center">
      <h2 className="text-2xl mb-2">Breeding</h2>
