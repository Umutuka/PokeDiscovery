...
const Breeding = ({ eggGroups, gender, eggCycles }) => {
  return (
    <div className="p-1 pb-8 space-y-3 text-base font-semibold border rounded-lg bg-slate-300 text-left">
      ...
      <p className="text-base">Egg Cycles: {eggCycles} (Maximum {eggCycles * 255} Steps to Hatch)</p>
    </div>
  );
};
