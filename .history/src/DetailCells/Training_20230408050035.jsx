...
const Training = ({
  ...
  return (
    <div className="p-5 font-mono text-3xl border rounded-lg bg-slate-300 justify-center items-center text-center">
      <ul>
        <li>EV Yield {ev}</li>
        ...
        <li className="flex text-3xl">
          ...
          {capitalizedArr.map((element, index) => (
            <p key={index} className="font-mono text-3xl">{element}</p>
          ))}
        </li>
      </ul>
    </div>
