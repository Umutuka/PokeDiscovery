...
const Training = ({
  ...
  return (
    <div className="p-5 text-3xl border rounded-lg bg-slate-300 justify-center items-center text-left">
      <h2 className="pb-5 text-left">Training</h2>
        
      <ul className="text-left flex flex-wrap justify-center items-center">
        ...
        <li className="font-thin" style={{ display: "inline-block" }}>
          Growth-Rate:
          {capitalizedArr.map((element, index) => (
            <p key={index} className="text-2xl inline">
