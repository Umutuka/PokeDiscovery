...
const Navbar = () => {
  ...
  return (
    <div className="border-b-3 mx-auto flex h-16 max-w-[2200px] items-center justify-between mt-n24 bg-gradient-to-b from-gray-700 to-gray-900 shadow-2xl">
      <h1 className="flex cursor-pointer items-center pb-1 font-mono text-3xl font-bold text-[#000300]">
        <FaReact></FaReact>ProgrammingQuizardo
      </h1>
      <nav>
