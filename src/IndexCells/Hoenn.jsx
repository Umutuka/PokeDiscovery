    ...
    <section id="Hoenn" className="Dex-List bg-slate-700">
      ...
      <div className="text-white">
        ...
        <div className="space-y-5 font-bold flex justify-center items-center p-5 text-2xl">
          <img src="https://drive.google.com/uc?export=view&id=1zZsxNlDBtnzyZL-WBLckhNlFIFbXU6Ou" className="w-32 h-46"></img>
          <img src="https://drive.google.com/uc?export=view&id=1ou4T1evhGOOzRQ6uUWm5lU0UXCvgQce2" className="w-44 h-46"></img>{" "}
          <p>
