    ...
    <section className="Dex-List bg-slate-700">
      ...
      <div className="text-white">
        ...
        <div className="space-y-5 font-bold flex justify-center items-center p-5 text-2xl">
          <img src="https://drive.google.com/thumbnail?id=1nPH610wd30Bb7Jk_LHpa1tOOa-uE1Y1s" className="w-48 h-46"></img>

          <img src="https://drive.google.com/thumbnail?id=1tAYkJM_cEXgRzUiU6Rt2WBa2yW1VPPAc" className="w-44 h-46"></img>
          <p>
