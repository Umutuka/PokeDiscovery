    ...
    <section className="Dex-List bg-slate-700">
      ...
      <div className="text-white Johto">
        ...
        <div className="space-y-5 font-bold flex justify-center items-center p-5 text-2xl">
          <img
            src="Pictures/Trainers/kanto_trainer.png"
            className="w-32 h-46"
          ></img>

          <img
            src="Pictures/Trainers/kantoMale_trainer.png"
            className="w-40 h-46"
          ></img>

          <p>
            The Kanto region (Japanese: カントー地方 Kanto region) is a region
            of the Pokémon world. Kanto is located east of Johto, which together
            form a joint landmass that is south of Sinnoh. Kanto is the setting
            of the first generation of games and can be explored in Generations
            II, III, IV, and VII.
          </p>
        </div>
      </div>
