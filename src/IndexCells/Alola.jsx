    ...
    <section className="Dex-List bg-slate-700">
      ...
      <div className="text-white">
        ...
        <div className="space-y-5 font-bold flex justify-center items-center p-5 text-2xl">
          <img src="https://drive.google.com/uc?export=view&id=1IOhg4BIEabyR0VAl3bYolxtoSbaB7IGg" className="w-36 h-46"></img>

          <img src="https://drive.google.com/uc?export=view&id=12ogFyl1g3eziU3w25lM3AVrJ6vbTB5_M" className="w-40 h-46"></img>
          <p>
