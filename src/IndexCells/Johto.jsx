    ...
    <section className="Dex-List bg-slate-700">
      ...
      <div className="text-white Johto">
        ...
        <div className="space-y-5 font-bold flex justify-center items-center p-5 text-2xl">
          <img src="https://drive.google.com/uc?export=view&id=1iWYPZzwzyvw8RwQnAbWqNLhRSpOzS6cS" className="w-56 h-46"></img>

          <img src="https://drive.google.com/uc?export=view&id=1GZ1IX6ekHP7_XYDMjTHdoauCQF3N0UI1" className="w-40 h-46"></img>
