  ...
  return (
    <tr>
      ...
      <td className="ability-name text-center">
        <img src={sprite} className="mx-auto my-auto"></img>{name.charAt(0).toUpperCase() + name.slice(1)}
      </td>
      ...
      <td className="ability-generation text-center text-1xl">
        {description}
      </td>

      
        <td className="view text-center hover:bg-white hover:cursor-pointer"><Link to={`/items/${id}`} >Link</Link></td>
