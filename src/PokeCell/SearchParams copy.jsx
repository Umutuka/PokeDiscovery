...
const SearchParams0 = ({ setTotalStats }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const totalStats = TotalStats0({ pokemonData: data });
      ...
      <div className="border rounded-lg shadow-xl bg-slate-300 justify-center items-center text-center">
        {pokemonData && (
          <div>
            ...
            <p>Total Stats: {<TotalStats0 pokemonData={pokemonData} />}</p>
          </div>
        )}
      </div>
    </div>
...
export { SearchParams0, TotalStats0 };
