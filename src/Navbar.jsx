...
const Navbar = () => {
  ...
  return (
    <div className="border-b-3 mx-auto flex h-16 items-center justify-between main-menu shadow-2xl">
      ...
      <div
        onClick={handleNav}
        className="block rounded-lg ml-20 m-5 lg:hidden bg-white"
      >
      ...
      <div
        className={
          !nav
            ? "fixed left-0 z-10 top-0 w-70% md:w-1/3 border-r border-r-gray-900 bg-[#000000] duration-500 ease-in-out"
            : "fixed left-[-100%]"
        }
      >
        ...
        <ul className="p-4 uppercase ">
          ...
          <li
            className="border-b border-gray-600 p-4 font-mono text-slate-200 cursor-pointer"
